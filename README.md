...
* 🚀  I'm currently working on [Learning Language with Nodes](https://github.com/gwilliamleung/kotoba-vault)
* 🧠  I'm currently working on an AI-powered language acquisition system that connects immersion, spaced repetition, and personal knowledge graphs so every word you encounter becomes a traceable memory — not just a flashcard. [Kotoba-vault](https://github.com/gwilliamleung/kotoba-vault)
